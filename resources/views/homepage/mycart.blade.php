    ...
    <div class="card-body">
        <div class="container padding-bottom-3x mb-1">
            ...
            <div class="shopping-cart-footer">
                ...
                <div class="column text-lg">Subtotal: <span class="text-medium">RM {{$cartTotal}}</span></div>
            </div>
            <div class="shopping-cart-footer">
