...
<td> Amount : RM{{ $order['amount'] }}</td>
<td> Name : {{ $order['firstName'] }}</td>
...
<body class="bg-red-100">
    <div class="container">
      <div class="space-y-4 mb-6">
        <h1 class="text-4xl fw-800">Thanks for your order, {{ $order['firstName'] }}</h1>
        <p>The estimated delivery time for your order is 6:10 PM - 6:20 PM. Track your order on the Zach Fashion website.</p>
      ...
      <div class="card rounded-3xl px-4 py-8 p-lg-10 mb-6">
        <h3 class="text-center">Receipt from  Zach Fashion </h3>
        <p class="text-center text-muted">Invoice No: {{ $order['invoice_number'] }}</p>
        <table class="p-2 w-full">
          <tbody>
            ...
            <tr>
                <td>Zip</td>
                <td class="text-right">{{ $order['zip'] }}</td>
            </tr>
            <tr>
              <td class="fw-700 border-top">Amount paid</td>
              <td class="fw-700 text-right border-top">RM {{ $order['amount'] }}</td>
            </tr>
          </tbody>
        </table>
        <hr class="my-6">
        <p>If you have any questions, contact us at <a href="https://bootstrapemail.com">support@zach-fashion.com</a>.</p>
      </div>
    </div>
  </body>
